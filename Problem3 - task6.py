...
Pmax = {'Coal': [120] * 24, 'Gas': [30] * 24,
        ...
        'Solar':[0, 0, 0, 0, 2, 5, 8, 10, 12, 15, 18, 22, 25, 28, 30, 30, 30, 
                 25,20, 15, 10, 5, 0, 0], 
        'Wind2':[0, 1, 0, 4, 7, 13, 21, 25, 31, 32, 41, 40, 31, 20, 14, 21, 26, 
                 29, 42, 43, 45, 41, 40, 29]}   

# Load [MW]
Pload =[30,20,20,30,50,80,100,140,120,100,90,80,70,80,120,160,220,200,180,160,120,
    100,80,40]
...
plt.savefig('plots/P3T6-PowerPlot.png', dpi=150)
