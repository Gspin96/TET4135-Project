...
Pmax = {'Coal': [120] * 24, 'Gas': [30] * 24,
        'Wind': [32, 51, 19, 25, 19, 4, 2, 1, 0, 0, 0, 0, 2, 4, 9, 1, 39, 32, 
                 14, 14, 19, 32, 32, 41] ,
...
try:
    ...
    plt.grid()
    plt.savefig('plots/P3T7Plot.png', dpi=150)
except ValueError:
    print("\033[33mModel values are not initialized, likely the solver didn't find a solution\033[0m")
